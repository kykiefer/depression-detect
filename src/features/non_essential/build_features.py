...
from dataframes import df_test_train
...
def in_test_train(partic_id):
    ...
    """
    return partic_id in set(df_test_train['Participant_ID'])

def get_deperession_label(partic_id):
    """
    Get particpants' depression labels.
    """
    binary_label = df_test_train.loc[df_test_train['Participant_ID'] == partic_id]['PHQ8_Binary'].values[0] # 1 is depression, 0 is not
    return binary_label


if __name__ == '__main__':
    dir_name = '/Users/ky/Desktop/depression-detect/data/interim/audio_segments' # directory containing segmented wav files
