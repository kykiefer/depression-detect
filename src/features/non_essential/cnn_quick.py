...
if __name__ == '__main__':
    ...
    X_train = np.load('/Users/ky/Desktop/depression-detect/data/processed/train_samples.npz')
    y_train = np.load('/Users/ky/Desktop/depression-detect/data/processed/train_labels.npz')
    X_test = np.load('/Users/ky/Desktop/depression-detect/data/processed/test_samples.npz')
    y_test = np.load('/Users/ky/Desktop/depression-detect/data/processed/test_labels.npz')

    X_train, y_train, X_test, y_test = X_train['arr_0'], y_train['arr_0'], X_test['arr_0'], y_test['arr_0']

    # cut sample size by 1/5 for speed/troubleshooting
