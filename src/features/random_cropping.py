...
To solve the problem, I perform random cropping on each of the particpant's spectrograms of a specified width (time) and contstant height (frequency), to ensure the CNN has an equal proportion for every subject and each class.
...
Some sucess has been found using random crops of 3-5 seconds [reference]. I'll start with 4 seconds and tune it like a hyperparameter. A width of 4 seconds means 4/0.032 = 125 pixel window size.
