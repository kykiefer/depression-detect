...
## Donate Your Data
The model needs your help! Detecting depression is *hard*. Robust speech recognition models rely on 100s of hours of audio data. For this reason, I created a [Flask](http://flask.pocoo.org/) app that utilizes [S3](https://aws.amazon.com/s3/) for storage.
...
1. Record a ~40 second anonymized audio file (and see a cool spectrogram of your audio recording!)
